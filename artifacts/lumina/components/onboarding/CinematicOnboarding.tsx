/**
 * CinematicOnboarding — the original 3-act opener (FROZEN, Phase 1).
 *
 * This is the legacy autonomous-swarm onboarding. It's preserved here
 * but no longer the default; the lean MVP onboarding (`MvpOnboarding`)
 * is wired into `app/onboarding.tsx`. Set
 *   EXPO_PUBLIC_USE_CINEMATIC_ONBOARDING=true
 * at build time to switch back to this experience.
 *
 ...
 *   Act 4 · CONSENT    FTC AI-disclosure + COPPA adult gate.
 */
