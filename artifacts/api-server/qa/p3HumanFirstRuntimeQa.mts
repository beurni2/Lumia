/**
 * N1-FOLLOWUP-NG-CLEAN-HIGH-HQS-CORPUS-LIFT-P3-HUMAN-FIRST runtime QA.
 *
...
const NEW_IMPORTS = new Set(["ng_clean_062", "ng_clean_063", "ng_clean_064"]);
...
async function main() {
  ...
  const fullOutPath = path.join(outDir, "n1_ng_clean_high_hqs_corpus_lift_p3_human_first.json");
  const summaryOutPath = path.join(outDir, "n1_ng_clean_high_hqs_corpus_lift_p3_human_first_summary.json");
