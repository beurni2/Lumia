...
export async function generateIdeas(
  ...
  const system = [
    ...
    "    • `whatToShow` — describe the visible skit in human terms: setup, action, turn, payoff. The object or action should carry the joke. Avoid abstract filler or a filming plan that could fit any idea.",
    "    • `howToFilm` — give 1–2 shootable sentences. Start with concrete framing or what must stay visible, then name the key action and the ending/payoff. Do not repeat whatToShow word-for-word, introduce a new premise, or use generic boilerplate like 'film yourself reacting' / 'let the joke land' / 'phone on a tripod'.",
    ...
    "  whatToShow (string 20–500 chars — describe the visible skit in human terms: setup, action, turn, payoff. The object or action should carry the joke. Avoid abstract filler or a filming plan that could fit any idea. Example: \"You're sitting on the couch holding your phone. Your face is fake-calm as you read the screen. Cut to over-the-shoulder of mom's text in caps. Cut back to your slow-motion 'oh no' sigh.\"),",
    "  howToFilm (string 15–400 chars — 1–2 shootable sentences. Start with concrete framing or what must stay visible, then name the key action and the ending/payoff. Do not repeat whatToShow word-for-word, introduce a new premise, or use generic boilerplate like 'film yourself reacting' / 'let the joke land' / 'phone on a tripod'. Example: \"Sit on the couch. Prop phone on a stack of books on the coffee table at chest height. One continuous take — no cuts. Have your actual phone in hand for the screen reaction.\"),",
  ...
  const user = [
    ...
    `whatToShow + howToFilm are USER-FACING trust signals — concrete, plain-English. whatToShow: setup → action → turn → payoff (the object/action carries the joke, no abstract filler). howToFilm: 1–2 shootable sentences (framing, key action, payoff) — never repeat whatToShow word-for-word and never use generic boilerplate ("film yourself reacting" / "let the joke land" / "phone on a tripod"). No "something" / "maybe" / "like…".`,
