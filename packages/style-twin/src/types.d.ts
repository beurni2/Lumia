...
export interface VisualFingerprint {
    ...
    readonly framingBias: {
        readonly thirdsScore: number;
...
export declare const MIN_SAMPLES = 10;
export declare const TIMBRE_DIMS = 192;
export declare const SCHEMA_VERSION = 1;
export declare const STORAGE_KEY = "lumina.styleTwin.v1";
